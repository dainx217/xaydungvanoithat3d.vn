...
function weblizar_admin_menu_pannel() {
	$page = add_theme_page( 'Weblizar', 'Tùy chỉnh giao diện', 'edit_theme_options', 'weblizar', 'weblizar_option_panal_function' ); 
			...
			<div id="content">
				<div id="options_tabs" class="ui-tabs ">
					<ul class="options_tabs ui-tabs-nav" role="tablist" id="nav">					
						<li class="active">
						<a href="#" id="general"><div class="dashicons dashicons-admin-home"></div><?php _e('Tùy chỉnh trang chủ','weblizar');?></a>
						<ul>
							<li class="currunt" ><a href="#" class="ui-tabs-anchor" id="general"><?php _e('Tùy chỉnh cơ bản','weblizar');?> </a></li>
							<li><a href="#"  id="home-image"><?php _e('Chỉnh Slide ảnh','weblizar');?></a></li>								
							<li><a href="#"  id="home-service"><?php _e('Chỉnh Dịch vụ','weblizar');?></a></li>
							<li><a href="#"  id="portfolio-settings"><?php _e('Portfolio Option','weblizar');?></a></li>	
							<li><a href="#"  id="footercall"><?php _e('Tùy chỉnh thông tin và footer','weblizar');?></a></li>
						</ul>
						</li>					
