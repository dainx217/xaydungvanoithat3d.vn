...
<div class="block ui-tabs-panel deactive" id="option-home-image" >
	<form method="post" id="weblizar_theme_options_home-image">
		...
		<div class="panel panel-default">		 
			...
			<div class="panel-body">
			<h3><?php _e('Slide số 4','weblizar'); ?></h3>
			...
			<h3><?php _e('Tiêu đề slide 4','weblizar'); ?></h3>
			...
			<span class="explain"><?php  _e('Nhập tiêu đề ảnh 4','weblizar');?></span>
		...
		<div class="panel panel-default">		 
			...
			<div class="panel-body">
			<h3><?php _e('Slide số 5','weblizar'); ?></h3>
			...
			<h3><?php _e('Tiêu đề slide 5','weblizar'); ?></h3>
			...
			<span class="explain"><?php  _e('Nhập tiêu đề ảnh 5','weblizar');?></span>
		
			<h3><?php _e('Home Slide Image Description Three','weblizar'); ?></h3>
			<input  class="weblizar_inpute" type="text" name="slide_desc_4" id="slide_desc_5"  value="<?php if($wl_theme_options['slide_desc_5']!='') { echo esc_attr($wl_theme_options['slide_desc_5']); } ?>" >	
			<span class="explain"><?php  _e('Type Home Slide Image Description Here','weblizar');?></span>
...
<div class="block ui-tabs-panel deactive" id="option-home-service" >
	<form method="post" id="weblizar_theme_options_home-service">
		...
		<div class="section">
			...
			<div class="panel-body">
			<hr>			
			<h3><?php _e('Ten dịch vụ','weblizar'); ?></h3>			
			...
			<input  class="weblizar_inpute" type="text" name="service_1_icons" id="service_1_icons"  value="<?php if($wl_theme_options['service_1_icons']!='') { echo esc_attr($wl_theme_options['service_1_icons']); } ?>" size="36" class="upload_image_button">	
			<input type="button" id="upload_button" value="Chọn ảnh" class="upload_image_button" />
			<br>
		...
		<div class="section">
			<div class="panel-group" id="accordion22">
			 <div class="panel panel-default">
				<div class="panel-heading">
				<h4 class="panel-title"><?php _e('Sản phẩm 2','weblizar'); ?><a data-toggle="collapse" data-parent="#accordion" href="#collapse22">
			...
			<div id="collapse22" class="panel-collapse collapse">
				<div class="panel-body">
				<hr>			
				<h3><?php _e('Tên sản phẩm','weblizar'); ?></h3>			
				...
				<span class="explain"><?php  _e('Type here your service title','weblizar');?></span>
				<h3><?php _e('Service  Icons','weblizar'); ?></h3>
				<input  class="weblizar_inpute" type="text" name="service_2_icons" id="service_2_icons"  value="<?php if($wl_theme_options['service_2_icons']!='') { echo esc_attr($wl_theme_options['service_2_icons']); } ?>" size="36" class="upload has-file">	
				<input type="button" id="upload_button" value="Chọn ảnh" class="upload_image_button" />
				<br>
				<span class="explain"><?php  _e('Service Icon (Using Bootstrap icons name) like: icon-tablet','weblizar');?> <a href="http://fortawesome.github.io/Font-Awesome/3.2.1/icons/" target="_blank"> <?php _e('Get your Font Awesome icons','weblizar'); ?>.</a> </span>
				<h3><?php _e('Service Description','weblizar'); ?></h3>			
		...
		<div class="section">
			<div class="panel-group" id="accordion22">
			 <div class="panel panel-default">
				<div class="panel-heading">
				<h4 class="panel-title"><?php _e('Sản phẩm 3','weblizar'); ?>
			...
			<div id="collapse23" class="panel-collapse collapse">
				...
				<span class="explain"><?php  _e('Type here your service title','weblizar');?></span>
				<h3><?php _e('Service  Icons','weblizar'); ?></h3>
				<input  class="weblizar_inpute" type="text" name="service_3_icons" id="service_3_icons"  value="<?php if($wl_theme_options['service_3_icons']!='') { echo esc_attr($wl_theme_options['service_3_icons']); } ?>" size="36" class="upload has-file">
				<input type="button" id="upload_button" value="Chon ảnh" class="upload_image_button" />	
				<br>
				<span class="explain"><?php  _e('Service Icon (Using Bootstrap icons name) like: icon-tablet','weblizar');?> <a href="http://fortawesome.github.io/Font-Awesome/3.2.1/icons/" target="_blank"> <?php _e('Get your Font Awesome icons','weblizar'); ?>.</a> </span>
				<h3><?php _e('Service Description','weblizar'); ?></h3>			
